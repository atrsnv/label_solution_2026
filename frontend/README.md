...
DataLens остается внешним BI-контуром, но основные экраны ERP рисуют данные сами, чтобы артист видел персональную аналитику без проблем iframe и embed-токенов. Для артистов источником считается backend-витрина `/api/artist/analytics`, привязанная к DataLens dashboard `ERP: Новые данные. Панель артиста`.
